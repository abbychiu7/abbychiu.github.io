...
jQuery(document).ready(function(){
	...
	abbychiu_tm_modalbox();
	abbychiu_tm_nav_bg();
	abbychiu_tm_trigger_menu();
	abbychiu_tm_modalbox_news();
	abbychiu_tm_modalbox_portfolio();
	abbychiu_tm_imgtosvg();
	abbychiu_tm_popup();
	abbychiu_tm_data_images();
	abbychiu_tm_swiper();
	myAccordion();
	abbychiu_tm_totop();
...
function abbychiu_tm_modalbox(){
	"use strict";
	
	jQuery('.abbychiu_tm_all_wrap').prepend('<div class="abbychiu_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>');
}
...
function abbychiu_tm_nav_bg(){
	
	"use strict";
	
	jQuery(window).on('scroll',function(){
		var menu	 		= jQuery('.abbychiu_tm_header');
...
jQuery('.abbychiu_progress').each(function() {
...
function abbychiu_tm_trigger_menu(){
	...
	var list			= jQuery('.abbychiu_tm_header .list ul li');
	var mobileMenu		= jQuery('.abbychiu_tm_mobile_menu .dropdown');
	var mobileMenuList	= jQuery('.abbychiu_tm_mobile_menu .dropdown .dropdown_inner ul li a');
...
function abbychiu_tm_modalbox_news(){
	
	"use strict";
	
	var modalBox		= jQuery('.abbychiu_tm_modalbox');
	var button			= jQuery('.abbychiu_tm_news .abbychiu_tm_full_link, .abbychiu_tm_news .news_list ul li .title a');
...
function abbychiu_tm_modalbox_portfolio(){
	
	"use strict";
	
	var modalBox	= jQuery('.abbychiu_tm_modalbox');
	var button		= jQuery('.abbychiu_tm_portfolio .portfolio_popup');
...
function abbychiu_tm_preloader(){
...
function abbychiu_tm_my_load(){
	
	"use strict";
	
	var speed	= 500;
	setTimeout(function(){abbychiu_tm_preloader();},speed);
	setTimeout(function(){jQuery('.abbychiu_tm_all_wrap').addClass('ready');},speed+2000);
}
...
function abbychiu_tm_data_images(){
...
function abbychiu_tm_swiper(){
	...
	$('.swiper-section').each(function(){
		...
		var mySwiper 	= new Swiper (container, {
			...
			pagination: {
				el: '.abbychiu_tm_swiper_progress',
				...
				renderCustom: function (swiper,current,total) {
					...
					var progressDOM	= container.find('.abbychiu_tm_swiper_progress');
...
function abbychiu_tm_progress_line(){
